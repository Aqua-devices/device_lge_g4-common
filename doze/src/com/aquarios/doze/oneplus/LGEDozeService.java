...
public class LGEDozeService extends Service {
    ...
    private LGEProximitySensor mSensor;
    ...
    class LGEProximitySensor implements SensorEventListener {
        ...
        public LGEProximitySensor(Context context) {
    ...
    public void onCreate() {
        ...
        mSensor = new LGEProximitySensor(mContext);
        mWakeLock = mPowerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "LGEDozeWakeLock");
